...
new_order <- c("MEblack", "MEred", "MEsalmon", "MEturquoise", "MEmidnightblue", 
              ...
              #"MEgreenyellow",
              "MEcyan", "MEbrown",
               "MEpurple",  "MElightcyan",  "MEmagenta", "MEpink", "MEblue", "MEyellow")

# Use order() and match() to get the row indices in the desired order based on new_order
row_indices <- order(match(rownames(moduleTraitCor_both),new_order))
...
ht=Heatmap(moduleTraitCor_both, name = "Eigengene", column_title = "Module-Trait Eigengene Correlation", 
        ...
        cluster_columns = hclust(dist(t(moduleTraitCor_both)), method = "average"),column_dend_height = unit(1.25, "in"),

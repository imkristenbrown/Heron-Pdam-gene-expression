...
ggsave("../../output/WGCNA/GO_analysis/CalcUpMods_GO_P00001_reduced.pdf", CalcUpMods_GO_P00001, width = 12, height = 36, units = c("in"), dpi=300, limitsize=FALSE)
```
...
ggsave("../../output/WGCNA/GO_analysis/CalcDownMods_GO_P00001.pdf", CalcUpMods_GO_P00001, width = 12, height = 36, units = c("in"), dpi=300, limitsize=FALSE)
```
...
ggsave("../../output/WGCNA/GO_analysis/CalcDownMods_GO_P00001_reduced.pdf", CalcUpMods_GO_P00001, width = 12, height = 36, units = c("in"), dpi=300, limitsize=FALSE)
```
...
The following list is a list of BP-ontology ("Biological Process") GO terms that were significantly enriched (P < 0.0001) within the modules that were upregulated for calcification. The list has been further reduced by using the package rrvgo.
...
The following list is a list of BP-ontology ("Biological Process") GO terms that were significantly enriched (P < 0.0001) within the modules that were downregulated for calcification. The list has been further reduced by using the package rrvgo.
...
length(unique(all_terms$GOterm))
```

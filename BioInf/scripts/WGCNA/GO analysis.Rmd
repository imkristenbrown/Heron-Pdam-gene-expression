...
```{r}
GOslim <- read.csv("../../data/map2MGIslim.csv") %>% dplyr::select(-term)
```

Based off of Jill's code at https://github.com/fscucchia/Hawaii2022_pH_Temp_Mcap_Pacu/blob/main/scripts/Functional_Enrichment.Rmd
...
ggsave("../../output/WGCNA/GO_analysis/Calc_Up_GOSlim.png", goterms_up_full_slim_plot, width = 10, height = 35)
ggsave("../../output/WGCNA/GO_analysis/Calc_Up_GOSlim.pdf", goterms_up_full_slim_plot, width = 10, height = 35)
```
...
ggsave("../../output/WGCNA/GO_analysis/Calc_Down_GOSlim.png", goterms_down_full_slim_plot, width = 10, height = 35)
ggsave("../../output/WGCNA/GO_analysis/Calc_Down_GOSlim.pdf", goterms_down_full_slim_plot, width = 10, height = 35)
```

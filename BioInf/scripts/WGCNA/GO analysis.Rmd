...
ggsave("../../output/WGCNA/GO_analysis/Top10_BP_by_mod/Brown.pdf", Top10Plot, width = 7, height = 5, units = c("in"), dpi=300, limitsize=FALSE)
```
...
simplifyGO(Mat, word_cloud_grob_param = list(max_width = 50),  min_term = 3, exclude_words = c("regulation", "process"))
dev.off()
```
...
ggsave("../../output/WGCNA/GO_analysis/Top10_BP_by_mod/Red.pdf", Top10Plot, width = 7, height = 5, units = c("in"), dpi=300, limitsize=FALSE)
```

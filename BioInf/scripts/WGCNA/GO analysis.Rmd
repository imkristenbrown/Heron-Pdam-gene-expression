...
```{r}
freq_fig_up_pval <- ggplot(goterms_shared_only, aes(x = reorder(ParentTerm, -N_in_Parent), y = bh_adjust_Up)) +
  geom_segment(aes(x = ParentTerm, xend = ParentTerm, y = 0, yend = bh_adjust_Up,),linewidth=.25) +
...
freq_fig_down_pval <- ggplot(goterms_shared_only, aes(x = reorder(ParentTerm, -N_in_Parent), y = bh_adjust_Down)) +
  geom_segment(aes(x = ParentTerm, xend = ParentTerm, y = 0, yend = bh_adjust_Down),linewidth=.25) +
...
ggsave(filename="../../output/WGCNA/GO_analysis/Up_Down_Shared_ParentTerms.pdf", plot=compare_figs, dpi=300, height=10, units="in", limitsize=FALSE)
```

```{r}
freq_fig_up_pval <- ggplot(goterms_up, aes(x = reorder(ParentTerm, -N_in_Parent), y = bh_adjust_Up)) +
  geom_segment(aes(x = ParentTerm, xend = ParentTerm, y = 0, yend = bh_adjust_Up,),linewidth=.25) +
  geom_point(size=1.5, alpha=1, colour = "red") +
  geom_hline(yintercept = 0, linetype = "solid", color = "grey", size = 0.5, show.legend = TRUE) +
  coord_flip() +
...
freq_fig_down_pval <- ggplot(goterms_down, aes(x = reorder(ParentTerm, -N_in_Parent), y = bh_adjust_Down)) +
  geom_segment(aes(x = ParentTerm, xend = ParentTerm, y = 0, yend = bh_adjust_Down),linewidth=.25) +
  geom_point(size=1.5, alpha=1, colour = "blue") +
  geom_hline(yintercept = 0, linetype = "solid", color = "grey", size = 0.5, show.legend = TRUE) +
  coord_flip() +

...
write.csv(GO_05, file = "../../output/WGCNA/GO_analysis/Biomin_genes/goseq_pattern_biomin.csv")
```

```{r}
go_results <-read.csv("../../output/WGCNA/GO_analysis/Biomin_genes/goseq_pattern_biomin.csv")
head(go_results)
```
...
pdf(file = "../../output/WGCNA/GO_analysis/Biomin_genes/biomin_GOSEM.pdf", width = 7, height = 5)
...
```{r}
#write.csv(go_results_BP_reduced, "../../output/WGCNA/GO_analysis/Biomin_genes/Biomineralization_goterms.csv")
write.csv(go_results_BP_reduced, "../../output/WGCNA/GO_analysis/Biomin_genes/goseq_pattern_biomin_filtered.csv")
```
...
```{r}
#write.csv(go_results_BP_reduced, "../../output/WGCNA/GO_analysis/Biomin_genes/Biomineralization_goterms.csv")
write.csv(go_results_BP_reduced, "../../output/WGCNA/GO_analysis/Biomin_genes/goseq_pattern_biomin_filtered_keywords.csv")
```
...
ggsave(filename="../../output/WGCNA/GO_analysis/Biomin_genes/GO.plot_biomin.pdf", plot=GO.plot_biomin, dpi=300, height=5, units="in", limitsize=FALSE)
```
...
# GO_05_biomin <- read.csv("../../output/WGCNA/GO_analysis/Biomin_genes/goseq_pattern_biomin.csv") %>% dplyr::select(-"X")
```
...
### Check which modules have overlap with the enriched terms for the biomin genes

```{r}
go_results_BP_up[which(go_results_BP_up$GOterm %in% go_results_BP_biomin$GOterm),]

go_results_BP_up[which(go_results_BP_up$GOterm %in% go_results_BP_biomin$GOterm),"Module"] %>% count()
go_results_BP_up[,"Module"] %>% count()

left_join(
  go_results_BP_up[which(go_results_BP_up$GOterm %in% go_results_BP_biomin$GOterm),"Module"] %>% count(),
  go_results_BP_up[,"Module"] %>% count(), by=join_by(x)) %>%
  mutate("Percent" = 100*(freq.x/freq.y)) %>% dplyr::arrange(-Percent)

#this shows us that red (4%) and salmon (2.5%) are the up-calcification modules with the largest percentage of enriched GO terms shared with the enriched GO terms of the biomineralization genes.
```

```{r}
go_results_BP_down[which(go_results_BP_down$GOterm %in% go_results_BP_biomin$GOterm),]

go_results_BP_down[which(go_results_BP_down$GOterm %in% go_results_BP_biomin$GOterm),"Module"] %>% count()
go_results_BP_down[,"Module"] %>% count()

left_join(
  go_results_BP_down[which(go_results_BP_down$GOterm %in% go_results_BP_biomin$GOterm),"Module"] %>% count(),
  go_results_BP_down[,"Module"] %>% count(), by=join_by(x)) %>%
  mutate("Percent" = 100*(freq.x/freq.y)) %>% dplyr::arrange(-Percent)

#magenta and turquoise both have two enriched GO terms shared with the enriched GO terms of the biomineralization genes. This represents less than 1% of the enriched terms in each module.
```
...
```{r}
#write.csv(go_results_BP_up_reduced_keywords, "../../output/WGCNA/GO_analysis/Biomin_genes/goseq_pattern_calcification_filtered.csv")
#write.csv(go_results_BP_down_reduced_keywords, "../../output/WGCNA/GO_analysis/Biomin_genes/goseq_pattern_calcification_down_filtered.csv")
#write.csv(go_results_BP_biomin_reduced_keywords, "../../output/WGCNA/GO_analysis/Biomin_genes/goseq_pattern_biomin_filtered.csv")
```
...
```{r}
#cal_biomin_terms <- read.csv("../../output/WGCNA/GO_analysis/Biomin_genes/goseq_pattern_biomin_filtered.csv")
...
```{r}
write.csv(goterms_shared_full, "../../output/WGCNA/GO_analysis/Biomin_genes/Merged_GOterms_factor_ParentTerm_with_Biomin.csv")
```

```{r}
goterms_shared_full <- read.csv("../../output/WGCNA/GO_analysis/Biomin_genes/Merged_GOterms_factor_ParentTerm_with_Biomin.csv")
```
...
ggsave(filename="../../output/WGCNA/GO_analysis/Biomin_genes/freq_fig_colored_sharedUpDown.pdf", plot=freq_fig_up, dpi=300, height=15, width=10, units="in", limitsize=FALSE)
```
...
ggsave(filename="../../output/WGCNA/GO_analysis/Biomin_genes/freq_fig_colored_sharedUpDown_gr20.pdf", plot=freq_fig_up, dpi=300, height=7, width=10, units="in", limitsize=FALSE)
```
...
ggsave(filename="../../output/WGCNA/GO_analysis/Biomin_genes/freq_fig_colored_sharedUpDown_80percentshared.pdf", plot=freq_fig_up, dpi=300, height=10, width=10, units="in", limitsize=FALSE)
```
...
ggsave(filename="../../output/WGCNA/GO_analysis/Biomin_genes/freq_fig_colored_sharedUpDown_80percentsharedordered.pdf", plot=freq_fig_up, dpi=300, height=10, width=10, units="in", limitsize=FALSE)
```
...
ggsave(filename="../../output/WGCNA/GO_analysis/Biomin_genes/freq_fig_up_colored_unique.pdf", plot=freq_fig_up, dpi=300, height=15, width=10, units="in", limitsize=FALSE)
```
...
ggsave(filename="../../output/WGCNA/GO_analysis/Biomin_genes/freq_fig_down_colored_unique.pdf", plot=freq_fig_down, dpi=300, height=15, width=10, units="in", limitsize=FALSE)
```
...
ggsave(filename="../../output/WGCNA/GO_analysis/Biomin_genes/freq_fig_up_colored_unique_biomin_only.pdf", plot=freq_fig_up, dpi=300, height=5, width=10, units="in", limitsize=FALSE)
```
...
ggsave(filename="../../output/WGCNA/GO_analysis/Biomin_genes/freq_fig_down_colored_unique_biomin_only.pdf", plot=freq_fig_down, dpi=300, height=5, width=10, units="in", limitsize=FALSE)
```
...
ggsave(filename="../../output/WGCNA/GO_analysis/Biomin_genes/freq_fig_up_colored_all.pdf", plot=freq_fig_up, dpi=300, height=25, width=10, units="in", limitsize=FALSE)
```
...
ggsave(filename="../../output/WGCNA/GO_analysis/Biomin_genes/freq_fig_down_colored_all.pdf", plot=freq_fig_down, dpi=300, height=25, width=10, units="in", limitsize=FALSE)
```
...
ggsave(filename="../../output/WGCNA/GO_analysis/Biomin_genes/freq_fig_up_colored_all_gr10.pdf", plot=freq_fig_up, dpi=300, height=10, width=10, units="in", limitsize=FALSE)
```
...
ggsave(filename="../../output/WGCNA/GO_analysis/Biomin_genes/freq_fig_down_colored_all_gr10.pdf", plot=freq_fig_down, dpi=300, height=10, width=10, units="in", limitsize=FALSE)
```

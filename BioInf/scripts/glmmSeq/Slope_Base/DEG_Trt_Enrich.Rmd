...
write.csv(GO, "../../../output/Slope_Base/GOSeq/Treatment/GOseq_DEG_Treatment.csv")
...
ggsave(filename=paste0("../../../output/Slope_Base/GOSeq/Treatment/TreatmentDEGs_P05", "_", category, ".png"), plot=GO.plot, dpi=300, height=10, units="in", limitsize=FALSE)
}
```
...
ggsave("../../../output/Slope_Base/GOSeq/Treatment/TreatmentDEGs_P05.pdf", GO_plot_all)
...
ggsave("../../../output/Slope_Base/GOSeq/Treatment/TreatmentDEGs_P05_orderedpval.pdf", GO_plot_all_pval)
```
...
ggsave("../../../output/Slope_Base/GOSeq/Treatment/TreatmentDEGs_P05.pdf", GO_plot_all, width = 12, height = 24, units = c("in"), dpi=300, limitsize=FALSE)
...
ggsave("../../../output/Slope_Base/GOSeq/Treatment/TreatmentDEGs_P05_orderedpval.pdf", GO_plot_all_pval, width = 12, height = 24, units = c("in"), dpi=300, limitsize=FALSE)
```
...
#Write file of results 
write.csv(KO, "../../../output/Slope_Base/GOSeq/Treatment/GOseq_KEGG_Treatment.csv")
```

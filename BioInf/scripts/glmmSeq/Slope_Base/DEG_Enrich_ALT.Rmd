---
title: "ALT VERSION _ WHOLE Gene list_ DEG_Enrich after glmmSeq, Slope as Base Level"
author: "Zoe Dellaert"
date: "4/24/2023"
...
write.csv(GO, "../../../output/Slope_Base/GOSeq/ALT_GOseq_DEG_Origin.csv")
...
ggsave(filename=paste0("../../../output/Slope_Base/GOSeq/ALT_OriginDEGs_P05", "_", category, ".png"), plot=GO.plot, dpi=100, width=12, height=100, units="in", limitsize=FALSE)
}
```
...
ggsave("../../../output/Slope_Base/GOSeq/ALT_OriginDEGs_P001.pdf", GO_plot_all, width = 28, height = 175, units = c("in"), dpi=100, limitsize=FALSE)
...
ggsave("../../../output/Slope_Base/GOSeq/ALT_OriginDEGs_P001_orderedpval.pdf", GO_plot_all_pval, width = 28, height = 175, units = c("in"), dpi=100, limitsize=FALSE)
```
...
head(KO_05)
#Write file of results 
write.csv(KO, "../../../output/Slope_Base/GOSeq/ALT_GOseq_KEGG_Origin.csv")
```
...
#Write file of results 
write.csv(GO_upSlope, "../../../output/Slope_Base/GOSeq/ALT_GOseq_DEG_Origin_upSlope.csv")
...
ggsave(filename=paste0("../../../output/Slope_Base/GOSeq/ALT_OriginDEGs_upslope_P05", "_", category, ".png"), plot=GO.plot_upslope, dpi=100, width=12, height=100, units="in", limitsize=FALSE)
}
```
...
#Write file of results 
write.csv(GO_upFlat, "../../../output/Slope_Base/GOSeq/ALT_GOseq_DEG_Origin_upFlat.csv")
...
ggsave(filename=paste0("../../../output/Slope_Base/GOSeq/ALT_OriginDEGs_upFlat_P05", "_", category, ".png"), plot=GO.plot_upFlat, dpi=100, width=12, height=100, units="in", limitsize=FALSE)
}
```

...
ggsave("../../../output/glmmseq/GOSeq/OriginDEGs_P001.pdf", GO_plot_all)
...
ggsave("../../../output/glmmseq/GOSeq/OriginDEGs_P05.pdf", GO_plot_all, width = 12, height = 24, units = c("in"), dpi=300, limitsize=FALSE)
...
write.csv(go_results, "../../../output/glmmseq/GOSeq/GOseq_DEG_Origin_filtered.csv")
...
write.csv(go_results, "../../../output/glmmseq/GOSeq/GOseq_DEG_Origin_filtered_more10.csv")

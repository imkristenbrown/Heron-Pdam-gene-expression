...
write.csv(GO, "../../../output/glmmseq/GOSeq/Interaction/GOseq_DEG_Interaction.csv")
...
ggsave(filename=paste0("../../../output/glmmseq/GOSeq/Interaction/InteractionDEGs_P05", "_", category, ".png"), plot=GO.plot, dpi=300, height=10, units="in", limitsize=FALSE)
}
```
...
ggsave("../../../output/glmmseq/GOSeq/Interaction/InteractionDEGs_P05.pdf", GO_plot_all)
...
ggsave("../../../output/glmmseq/GOSeq/Interaction/InteractionDEGs_P05_orderedpval.pdf", GO_plot_all_pval)
```
...
ggsave("../../../output/glmmseq/GOSeq/Interaction/InteractionDEGs_P05.pdf", GO_plot_all, width = 12, height = 24, units = c("in"), dpi=300, limitsize=FALSE)
...
ggsave("../../../output/glmmseq/GOSeq/Interaction/InteractionDEGs_P05_orderedpval.pdf", GO_plot_all_pval, width = 12, height = 24, units = c("in"), dpi=300, limitsize=FALSE)
```
...
#Write file of results 
write.csv(KO, "../../../output/glmmseq/GOSeq/Interaction/GOseq_KEGG_Interaction.csv")
```

---
title: "DEG_Enrich after glmmSeq,Interaction DEGs"
author: "Zoe Dellaert"
date: "11/01/2023"
...
Order geneInfo0 by significance of Interaction, q_Interaction (adjusted p value)
```{r}
geneInfo <- geneInfo0[order(geneInfo0[, 'q_Interaction']), ]
...
### Generate vector with names of the 30 significant DEGs by Interaction
ID.vector <- geneInfo %>%
  filter(q_Interaction < 0.05) %>%
  pull(gene_id)
...
##Construct list of genes with 1 for genes in that are significant for Interaction and 0 for those that are not
gene.vector = as.integer(ALL.vector %in% ID.vector) #since we ordered geneInfo by q_Interaction, this puts a "1" for the first 18 genes, which are the same genes in ID.vector
...
```{r}
#how many go terms from the 30 genes

##Get a list of GO Terms for the 30 DE genes
GO.terms_DE <- geneInfo %>% filter(q_Interaction < 0.05) %>%
  dplyr::select(gene_id, Annotation.GO.ID)
...
write.csv(GO, "../../../output/Slope_Base/GOSeq/Interaction/GOseq_DEG_Interaction.csv")
...
ggsave(filename=paste0("../../../output/Slope_Base/GOSeq/Interaction/InteractionDEGs_P05", "_", category, ".png"), plot=GO.plot, dpi=300, height=10, units="in", limitsize=FALSE)
}
```
...
ggsave("../../../output/Slope_Base/GOSeq/Interaction/InteractionDEGs_P05.pdf", GO_plot_all)
...
ggsave("../../../output/Slope_Base/GOSeq/Interaction/InteractionDEGs_P05_orderedpval.pdf", GO_plot_all_pval)
```
...
ggsave("../../../output/Slope_Base/GOSeq/Interaction/InteractionDEGs_P05.pdf", GO_plot_all, width = 12, height = 24, units = c("in"), dpi=300, limitsize=FALSE)
...
ggsave("../../../output/Slope_Base/GOSeq/Interaction/InteractionDEGs_P05_orderedpval.pdf", GO_plot_all_pval, width = 12, height = 24, units = c("in"), dpi=300, limitsize=FALSE)
```
...
#Write file of results 
write.csv(KO, "../../../output/Slope_Base/GOSeq/Interaction/GOseq_KEGG_Interaction.csv")
```

Over-represented KEGG terms, p = 0.05:
"K04911" "K03241" "K20027" "K21644" "K12870" "K02377" "K04399" "K19177" "K21878" "K03678" "K17879" "K05122" "K20103" "K02183"

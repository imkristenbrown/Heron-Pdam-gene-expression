---
title: "WGCNA Results into Functional Enrichment and Biomineralization Toolkit Analysis"
...
```{r}
library(tidyr)
biomin_all_filtered_long <- pivot_longer(biomin_all, cols=31:75, names_to = "Colony", values_to = "Expression")

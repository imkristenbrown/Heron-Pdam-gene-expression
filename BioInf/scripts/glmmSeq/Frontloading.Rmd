...
For frontloading analysis, I am going to start by looking at the 480 genes that were upregulated in Flat in both Stable and Variable Treatments
...
Now we have a set of 480 genes, that regardless of treatment were significantly upregulated in the Flat Origin.


## Do we want to remove the q_val significance filter? And just look at all genes that are upregulated in Flat regardless of significance? That's what we had discussed but I am going to continue on this path for now

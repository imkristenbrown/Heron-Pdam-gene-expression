---
title: "glmmSeq, with pOverA filtering and outliers removed"
author: "Zoe Dellaert"
date: "3/29/2023"
...
write.csv(stats, "../../output/signif_genes.csv") #save stats file as csv for downstream analysis
```
...
write.csv(predict, "../../output/model_expression_prediction_allgenes.csv") #save stats file as csv for downstream analysis
```
...
write.csv(stats_cts_merge_rawcts, "../../output/signif_genes_rawcts.csv") #save this as csv for downstream analysis
write.csv(stats_cts_merge_cts, "../../output/signif_genes_cts.csv") #save this as csv for downstream analysis
write.csv(stats_cts_merge_norm, "../../output/signif_genes_normcts.csv") #save this as csv for downstream analysis
```
...
sum(Treatment_DEGs[,"Gene"] %in% Origin_DEGs[,"Gene"]) #how many of these genes are also significant by Origin? 12
...
sum(Treatment_DEGs_notOrigin %in% Interaction_DEGs[,"Gene"]) #how many of these genes are also significant by Interaction? 4

# four of those are also significant by the interaction term! Let's look more into the 3 that are not significant by Origin or Interaction
...
sum(Interaction_DEGs[,"Gene"] %in% Origin_DEGs[,"Gene"]) #how many of these genes are also significant by Origin? 26

#let's list the 11 genes that are significant by interaction but not by Origin
...
sum(Interaction_DEGs_notOrigin %in% Treatment_DEGs[,"Gene"]) #how many of these genes are also significant by Treatment? 4

# four of those are also significant by the treatment! Let's look more into the 7 that are not significant by Origin or Treatment
...
- Origin_DEGs (847 genes)
- Treatment_DEGs (19 genes)
- Interaction_DEGs(37 genes)
- Treatment_DEGs_ONLY (3 genes)
- Interaction_DEGs_ONLY (7 genes)

```{r}
write.csv(Origin_DEGs, "../../output/DEGs/Origin_DEGs.csv") #save this as csv for downstream analysis
write.csv(Treatment_DEGs, "../../output/DEGs/Treatment_DEGs.csv") #save this as csv for downstream analysis
write.csv(Interaction_DEGs, "../../output/DEGs/Interaction_DEGs.csv") #save this as csv for downstream analysis
write.csv(DEGs[Treatment_DEGs_ONLY,], "../../output/DEGs/Treatment_DEGs_ONLY.csv") #save this as csv for downstream analysis
write.csv(DEGs[Interaction_DEGs_ONLY,], "../../output/DEGs/Interaction_DEGs_ONLY.csv") #save this as csv for downstream analysis
```

...
for (category in ontologies) {
    ...
    filename <-  paste0("../../../output/glmmseq/GOSeq/Interaction/GOseq_InteractionDEGs_filtered_P05_", category, ".csv")
...
ggsave(filename=paste0("../../../output/glmmseq/GOSeq/Interaction/InteractionDEGs_P05", "_", category, ".png"), plot=GO.plot, dpi=300, height=20, width=15, units="in", limitsize=FALSE)
}
```
...
pdf(file = "../../../output/glmmseq/GOSeq/Interaction/InteractionDEGs_P05_GOSEM.pdf", width = 7, height = 5)

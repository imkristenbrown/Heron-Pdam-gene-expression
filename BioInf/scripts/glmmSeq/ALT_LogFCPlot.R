...
ALT_LogfcPlot <- function (object, x1var, x2var, x1Values = NULL, x2Values = NULL, 
                                                                             ...
                                                                             "goldenrod1", "red", "blue"), verbose = FALSE, ...) 
{
  ...
  plotData <- data.frame(x =   log2(predData[, xCols[2]]  /predData[, xCols[1]]),
                         y  = log2(predData[, yCols[2]]/predData[, yCols[1]]))

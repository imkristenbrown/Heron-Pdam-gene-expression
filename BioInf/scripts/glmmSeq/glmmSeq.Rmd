...
write.csv(Treatment_DEGs_ONLY, "../../output/DEGs/Treatment_DEGs_ONLY.csv") #save this as csv for downstream analysis
write.csv(Interaction_DEGs_ONLY, "../../output/DEGs/Interaction_DEGs_ONLY.csv") #save this as csv for downstream analysis
```
